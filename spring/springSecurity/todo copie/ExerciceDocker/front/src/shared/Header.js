...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/products">Tasks</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/create-task">Create</a>
            </li>
        </ul>
        <div class="ml-auto"> {/* Utilise ml-auto pour aligner le contenu à droite */}
            {!isLoggedIn() ? (
                ...
                <>
                    <span className="navbar-text mr-4">Bonjour, {extractBeforeAt(userDetails.name)}</span>
